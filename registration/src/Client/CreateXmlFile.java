...
public class CreateXmlFile {
	...
	public CreateXmlFile(String accNum,String firstName,String lastName,String UserName,String Email,String password,String gender) throws Exception  {
		
		String[] elementValue= {firstName,lastName,UserName,Email,password,gender};
		String[] elementName= {"firstNmae","lastName","userName","Email","password","gender"};
