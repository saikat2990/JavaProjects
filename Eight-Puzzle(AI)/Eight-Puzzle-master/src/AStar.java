...
public class AStar {
	...
	/**
	 * Constructor. Instantiates startState, open list, closed list, and
	 * shuffles the board.
	 */
	public AStar(int hc){
	 ...
	 * @param
	 * @return void
	 * Uses Fisher-Yates algorithm to shuffle board
	 */
	 ...
	 * returns a list of the current node's "neighbours"
	 */
	 ...
	 * @param
	 * @return int
	 * performs heuristic based on whether it's hamming distance
